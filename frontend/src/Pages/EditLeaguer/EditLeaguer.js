...
export default function EditLeaguer() {
    ...
    const dataTeam = useRequestData([], `${base_Url}/leaguer/edit/${params.id}`,{ headers: { authorization: localStorage.getItem("token") }})[0]
            ...
            <Background >
                <Layout>
                    <Center>
                        ...
                        <Typography variant="h2" fontSize={19} sx={{ marginBottom: 1 }} >Editar Leaguer</Typography>
